      ...
      <div className="min-h-[95vh] md:mx-auto overflow-y-hidden md:max-w-[1200px] grid md:grid-cols-[1fr_1fr] md:gap-3 items-center md:justify-center">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-md mx-auto w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Signup Button */}
            {errorMessage && <div className="text-xs md:text-sm text-danger text-center">{errorMessage}</div>}
            <button
              disabled={loading}
              type="submit"
              className="w-full mt-4 bg-primary text-white py-2 text-sm md:text-base rounded-lg font-semibold hover:bg-primary-light cursor-pointer transition"
            >
